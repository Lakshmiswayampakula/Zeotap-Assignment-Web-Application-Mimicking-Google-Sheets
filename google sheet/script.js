...
// Toggle Data Quality dropdown menu
document.querySelector('.data-quality-menu').addEventListener('click', function() {
    document.querySelector('.data-quality-dropdown').classList.toggle('show');
});

// Close the dropdown when clicking outside of it
window.addEventListener('click', function(event) {
    if (!event.target.matches('.data-quality-menu')) {
        const dropdowns = document.getElementsByClassName('data-quality-dropdown');
